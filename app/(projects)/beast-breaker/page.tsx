    ...
    <>
      ...
      <ProjectContent>
        ...
        <ProjectImage
          ...
          width={1280}
          height={720} />
        <p>The core gameplay revolves around battling monsters, crafting equipment, conversing with companions, and uncovering the narrative over the course of a 15-hour playthrough.</p>
        <ProjectImage
